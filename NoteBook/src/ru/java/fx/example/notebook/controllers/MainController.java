package ru.java.fx.example.notebook.controllers;
...
import ru.java.fx.example.notebook.interfaces.impls.CollectionAddressBook;
import ru.java.fx.example.notebook.objects.Person;
import ru.java.fx.example.notebook.utils.DialogManager;
...
public class MainController implements Initializable {
    ...
    private void initLoader() {
        try {
            ...
            fxmlLoader.setResources(ResourceBundle.getBundle("ru.java.fx.example.notebook.bundles.Locale", new Locale("ru")));
